package com.rafaelahmedov.flippybird;
...
public class FlippyBird extends ApplicationAdapter {
    ...
    public void startGame(){
        ...
        for (int i = 0; i < numberOfTubes; i++) {
            tubeX[i] = Gdx.graphics.getWidth() / 2 - topTube.getWidth() / 2 + Gdx.graphics.getHeight() + i * distanceBetweenTubes;
    ...
    public void render() {
        ...
        fonts.draw(batch, String.valueOf(score), 100, 100);
